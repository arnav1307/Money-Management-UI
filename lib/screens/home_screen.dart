...
import 'package:moneyapp/models/card_model.dart';
import 'package:moneyapp/models/operation_model.dart';
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image:DecorationImage(image: AssetImage('assets/images/user_photo.png'),),
                    ),
                  ),
                ],
              ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text('Jack Daniels',style: GoogleFonts.inter(
            ...
            //Card Details or the image to be put over here
              Container(
                height: 200,
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[Text('Operations',
                  style: GoogleFonts.inter(
                    fontSize: 20,
                    fontWeight: FontWeight.w700,
                    color: kBlackColor,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        ],borderRadius: BorderRadius.circular(20),color: widget.isSelected?kBlueColor:kWhiteColor
      ),
      child: Column(
